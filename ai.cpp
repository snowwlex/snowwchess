...
BruteForceAIPlayer::BruteForceAIPlayer(int color, Model* model, BoardCLIView *boardView, CLIView * userView, int depth):
		AIPlayer(color,model,boardView,userView,depth) { }

PlayerCommand BruteForceAIPlayer::makeTurn(Move& move, GameMessage message) {
...
int BruteForceAIPlayer::miniMaxSearch(Move& returnMove, int curDepth, int curPlayer, const Model& model) {
	MOVES moves;
	Move bestMove;
...
AlphaBetaAIPlayer::AlphaBetaAIPlayer(int color, Model* model, BoardCLIView *boardView, CLIView * userView, int depth):
		AIPlayer(color,model,boardView,userView,depth) { }
...
int AlphaBetaAIPlayer::alphaBetaNegaMaxSearch(Move& returnMove, Border alpha, Border beta, int curPlayer, int curDepth , const Model& model) {
	MOVES moves;
	Move bestMove;
	MOVES::iterator itMove;
	int tmpScore;
